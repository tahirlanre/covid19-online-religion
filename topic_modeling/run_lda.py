...
parser.add_argument(
    "--num-topics", type=int, default=50, help="num topics (default=50)"
)
parser.add_argument(
    "--num-terms", type=int, default=20, help="num terms to print (default=20)"
)
parser.add_argument("--num-workers", type=int, default=8, help="num topics (default=8)")
...
lda_model_tfidf = models.LdaMulticore(
    corpus_tfidf, num_topics=n_topics, id2word=dictionary, passes=10, workers=n_workers
)
