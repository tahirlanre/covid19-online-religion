...
def main():
    ...
    for epoch in range(args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            if args.log_steps > 0 and completed_steps % args.log_steps == 0:
                # log interval loss
                train_loss = train_loss / args.log_steps
        ...
        wandb.log({"perplexity": perplexity, "loss/eval": eval_loss})
        logger.info(f"epoch {epoch}: loss/eval: {eval_loss} perplexity: {perplexity}")
